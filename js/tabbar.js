// Tab bar component — include on every page
(function() {
  ...
  var tabs = [
    ...
    { id: 'community', label: 'Community', href: base + '/community.html', paths: ['/community'],
    ...
    { id: 'profile', label: 'Profile', href: base + '/profile.html', paths: ['/profile'],
      icon: '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>' }
  ];

  var html = '<div class="mm-tab-bar"><div class="mm-tab-bar-inner">';
  tabs.forEach(function(tab) {
    var active = isActive(tab.paths) ? ' active' : '';
    html += '<a class="mm-tab-item' + active + '" href="' + tab.href + '">';
    html += '<div class="mm-tab-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">' + tab.icon + '</svg></div>';
    html += '<span class="mm-tab-label">' + tab.label + '</span>';
    html += '</a>';
  });
  html += '</div></div>';
